...
impl IdlePage {
    ...
    pub fn new(app_state: Rc<RefCell<AppState>>) -> Self {
        ...
        screen_off_timeout_spin
            .set_subtitle("Turn screen off after this many seconds (0 = disabled)");
    ...
    pub fn load_idle(&self, config: &IdleConfig) {
        ...
        self.screen_off_timeout_spin
            .set_value(config.screen_off_timeout as f64);
    ...
    pub fn bind_detection(&self, has_swayidle: bool, has_locker: bool) {
        ...
        self.preferences_group
            .set_sensitive(has_swayidle && has_locker);
    }
